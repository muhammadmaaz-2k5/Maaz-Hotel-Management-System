...
import { useGetHealthQuery, useGetDetailedHealthQuery } from "../store/apiSlice";
import {
  Activity,
  Server,
  Database,
...
const ApiStatus = () => {
  ...
  } = useGetDetailedHealthQuery(undefined, {
    skip: !(isDetailed && isLoggedIn),
    pollingInterval: isDetailed && isLoggedIn ? 30000 : 0,
  });
  ...
  const needsSignInForDetails =
    ...
    (!isLoggedIn ||
      (isDetailedError &&
        (detailedError as any)?.status === 401));
