...
import { useGetMyHotelsQuery, useUpdateMyHotelActiveMutation } from "../store/apiSlice";
...
const MyHotels = () => {
  ...
  const {
    ...
    isFetching,
  } = useGetMyHotelsQuery(undefined, {
    skip: !isLoggedIn,
  });

  const [updateHotelActive, { isLoading: isUpdatingActive }] = useUpdateMyHotelActiveMutation();

  const handleUpdateActive = async (hotelId: string, isActive: boolean) => {
    try {
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleUpdateActive(hotel._id, hotel.isActive === false)
                  }
                >
