...
import { useGetHotelByIdQuery, useGetHotelReviewsQuery } from "../store/apiSlice";
...
const Detail = () => {
  ...
  const { data: hotel, isLoading: isHotelLoading } = useGetHotelByIdQuery(hotelId as string, {
    skip: !hotelId,
  });

  const { data: reviews, isLoading: isReviewsLoading } = useGetHotelReviewsQuery(hotelId as string, {
    skip: !hotelId,
  });
