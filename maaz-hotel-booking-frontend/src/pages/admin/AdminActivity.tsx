import { useGetAdminBookingsQuery, useGetAdminReviewsQuery } from "../../store/apiSlice";
...
const AdminActivity = () => {
  const { data: bookings, isLoading: bLoading } = useGetAdminBookingsQuery();
  const { data: reviews, isLoading: rLoading } = useGetAdminReviewsQuery();
